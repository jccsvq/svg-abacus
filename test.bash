...
echo 7 8 9 10 11 12 13 14 15 19 17 18 19|./svg-abacus -t 43 -s 50  -d 0 -c > test-results/43c.svg
...
echo T 1 2 3 4 9 6 8 9 F 5 3 0|./svg-abacus -t 51 -s 50  -d 0 -c > test-results/51c.svg
...
echo 0 0s 1 1s 2 2s 3 3s 4 4s 0|./svg-abacus -t 51  > test-results/51js.svg
...
echo T 1 2 13 4 9 16 8 9 F Q 20|./svg-abacus -t 52 -s 50  -d 0 > test-results/52j.svg
echo T 1 2 13 4 9 16 8 9 F Q 20|./svg-abacus -t 52 -s 50  -d 3 -c > test-results/52cd.svg
...
echo T 1 2 13 4 9 16 8 9 F Q 20|./svg-abacus -t 53 -s 50  -d 0 -c > test-results/53c.svg
echo T 1 2 13 4 9 16 8 9 F Q 20|./svg-abacus -t 53 -s 50  -d 0 -c -b > test-results/53cb.svg
