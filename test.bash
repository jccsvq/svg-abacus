echo 0 1 2 3 4 9 6 8 9 1 2 3|./svg-abacus -t 41 -s 50  -d 3 -l -b> test-results/41jd.svg
echo 0 1 2 3 4 9 6 8 9 1 2 3|./svg-abacus -t 41 -s 50  -d 0 > test-results/41j.svg
echo 0s 1s 2s 3s 4s 5s 6s 7s 8s 9s 1 2 3|./svg-abacus -t 41 -s 50  -d 3 -c -l> test-results/41cd.svg
...
echo T 1 2 13 4 9 16 8 9 F Q 20|./svg-abacus -t 52 -s 50  -d 0 -l -n> test-results/52j.svg
